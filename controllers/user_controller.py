...
def read_users(
    ...
    total_registros = db.query(func.count(Users.id)).scalar()  # Cuenta el número total de registros
    ...
    users = db.query(Users).offset(offset).limit(limit).all()  # Obtiene los usuarios con paginación
    ...
    return {
        ...
        "data": users  # Devuelve los datos paginados
    }
